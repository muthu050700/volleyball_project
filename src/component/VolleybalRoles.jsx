...
const VolleybalRoles = () => {
  return (
    <motion.div className=" text-white flex flex-col bg-slate-800 p-4 py-20">
      <motion.h1
      ...
      <motion.div className="grid md:grid-row-2 md:grid-cols-2 xl:grid-cols-3 xl:grid-rows-3 place-items-center gap-10">
